...
@section('content')
    <div class="row">
        <div class="col-sm-12 col-md-12">
            <div class="card-box">
                <h4 class="header-title text-primary mb-3 pb-1 border-bottom border-primary">{{ __('page.edit_page_title', ['title' => $page->title]) }} </h4>
                <form id="create-page" method="post" action="{{ route('admin.page.update', $page->id) }}">
                    @csrf

                    @foreach ($langs as $lang)
                        <div class="form-group clearfix">
                            <label class="control-label" for="{{ $lang }}_title">{{ __('page.' . $lang . '_title') }}</label>
                            <input class="form-control required" id="{{ $lang }}_title" name="{{ $lang }}_title" type="text" value="{{ $page->{$lang . '_title'} }}">
                        </div>
                        <div class="form-group clearfix">
                            <label class="control-label" for="s">{{ __('page.' . $lang . '_description') }}</label>
                            <textarea class="ckEditor" name="{{ $lang }}_description">{{ $page->{$lang . '_description'} }}</textarea>
